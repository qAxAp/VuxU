...
function Library:CreateWindow(windowname,windowinfo)
    ...
    DashBoard.BackgroundColor3 = Color3.fromRGB(52, 0, 69)
    ...
    TabContainer.BackgroundColor3 = Color3.fromRGB(52, 0, 69)
    ...
    PageContainer.BackgroundColor3 = Color3.fromRGB(148, 4, 196)
    ...
    Title.Name = "Title"
    Title.Parent = Frame
    Title.BackgroundColor3 = Color3.fromRGB(148, 4, 196)
